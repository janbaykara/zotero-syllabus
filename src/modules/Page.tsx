  ...
  return (
    <div>
      ...
      <p>
        <input
          type="text"
          value={syllabusMetadata.description}
          onChange={(e) =>
            setDescription(
              e.target?.value || syllabusMetadata.description || "",
            )
          }
        />
      </p>
      ...
      <ul>
        {Object.keys(syllabusMetadata.classes || {}).map((classNumber) => (
          <li key={classNumber}>
            ...
            <input
              type="text"
              value={syllabusMetadata.classes?.[classNumber].title}
              onChange={(e) =>
                setClassTitle(
            ...
            <input
              type="text"
              value={syllabusMetadata.classes?.[classNumber].description}
              onChange={(e) =>
                setClassDescription(
                  parseInt(classNumber),
                  e.target?.value ||
