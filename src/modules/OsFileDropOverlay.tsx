...
import { SYLLABUS_FILE_DROP_OVERLAY_CLASS } from "./syllabusFileDrop";
...
export function OsFileDropOverlay({ visible }: { visible: boolean }) {
  ...
  return (
    <div
      className={`${SYLLABUS_FILE_DROP_OVERLAY_CLASS} sticky h-full inset-0 z-50 bg-accent-blue/10 backdrop-blur-sm flex items-center justify-center pointer-events-none in-[.print]:hidden`}
    >
