...
page-compact-enable = Ativar o modo compacto
page-compact-disable = Desativar o modo compacto
page-reader-enable = Ativar o modo de leitura
page-reader-disable = Desativar o modo de leitura
...
page-print = Imprimir a lista na vista de programa como PDF
...
schedule-settings-back = Voltar ao calendário de leituras
...
progress-print-preparing = A preparar o programa para impressão…
progress-print-failed = Não foi possível guardar o PDF do programa
