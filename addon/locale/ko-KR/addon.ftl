...
dialog-save-markdown = 강의계획을 Markdown으로 저장
file-filter-markdown = Markdown
dialog-save-html = 강의계획을 HTML로 저장
...
my-annotations-empty-color-filter = 선택한 색의 주석이 없습니다
...
annotations-quote-order-menu = 주석 정렬
annotations-quote-order-location = 위치
...
my-annotations-menu-color = 색으로 필터
my-annotations-menu-color-clear = 색 필터 지우기
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = 노랑
my-annotations-color-light-yellow = 연한 노랑
my-annotations-color-red = 빨강
my-annotations-color-green = 초록
my-annotations-color-blue = 파랑
my-annotations-color-purple = 보라
my-annotations-color-magenta = 자홍
my-annotations-color-orange = 주황
my-annotations-color-gray = 회색
