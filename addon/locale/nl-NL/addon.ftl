...
page-print = De lijst in de syllabusweergave als PDF afdrukken
...
progress-print-preparing = Syllabus voorbereiden voor afdrukken…
progress-print-failed = Het syllabus-PDF kon niet worden opgeslagen
