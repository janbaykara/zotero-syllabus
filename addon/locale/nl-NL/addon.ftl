...
my-annotations-empty-color-filter = Geen annotaties komen overeen met de geselecteerde kleuren
...
annotations-quote-order-menu = Annotaties sorteren
...
my-annotations-menu-color = Filteren op kleur
my-annotations-menu-color-clear = Kleurfilter wissen
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Geel
my-annotations-color-light-yellow = Lichtgeel
my-annotations-color-red = Rood
my-annotations-color-green = Groen
my-annotations-color-blue = Blauw
my-annotations-color-purple = Paars
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Oranje
my-annotations-color-gray = Grijs
