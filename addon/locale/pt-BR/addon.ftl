...
magazine-blurb-open = Abrir este trecho no leitor
...
progress-print-preparing = Preparando o programa…
progress-print-failed = Não foi possível salvar o programa
...
file-filter-pdf = PDF
dialog-save-word = Salvar programa como Word
file-filter-word = Word
dialog-save-markdown = Salvar programa como Markdown
file-filter-markdown = Markdown
dialog-save-html = Salvar programa como HTML
...
annotations-quote-order-location = Local
...
my-annotations-color-gray = Cinza
