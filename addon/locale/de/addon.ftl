...
explorer-annotations-size = Größe
explorer-annotations-size-small-title = Kompakte, gekürzte Zitate
explorer-annotations-size-large-title = Vollständige Zitate
