...
magazine-blurb-open = Diesen Auszug im Reader öffnen
...
my-annotations-empty-color-filter = Keine Annotationen entsprechen den ausgewählten Farben
...
annotations-quote-order-menu = Annotationen sortieren
...
annotations-activity-gap-later =
    { $unit ->
        ...
        [week] { $count ->
            [one] eine Woche später
           *[other] { $count } Wochen später
        }
        [month] { $count ->
...
annotations-activity-gap-earlier =
    { $unit ->
        [day] { $count ->
            [one] einen Tag früher
           *[other] { $count } Tage früher
        }
        [week] { $count ->
            [one] eine Woche früher
           *[other] { $count } Wochen früher
        }
        [month] { $count ->
            [one] einen Monat früher
           *[other] { $count } Monate früher
        }
        [year] { $count ->
            [one] ein Jahr früher
           *[other] { $count } Jahre früher
        }
       *[other] früher
    }
...
my-annotations-menu-color = Nach Farbe filtern
my-annotations-menu-color-clear = Farbfilter zurücksetzen
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Gelb
my-annotations-color-light-yellow = Hellgelb
my-annotations-color-red = Rot
my-annotations-color-green = Grün
my-annotations-color-blue = Blau
my-annotations-color-purple = Lila
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Orange
my-annotations-color-gray = Grau
