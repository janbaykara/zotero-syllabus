...
my-annotations-empty-color-filter = Không có chú thích khớp với màu đã chọn
...
annotations-quote-order-menu = Sắp xếp chú thích
...
my-annotations-menu-color = Lọc theo màu
my-annotations-menu-color-clear = Xóa bộ lọc màu
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Vàng
my-annotations-color-light-yellow = Vàng nhạt
my-annotations-color-red = Đỏ
my-annotations-color-green = Xanh lục
my-annotations-color-blue = Xanh dương
my-annotations-color-purple = Tím
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Cam
my-annotations-color-gray = Xám
