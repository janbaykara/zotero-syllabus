...
page-print = In danh sách ở chế độ xem Đề cương thành PDF
...
progress-print-preparing = Đang chuẩn bị đề cương để in…
progress-print-failed = Không thể lưu PDF đề cương
