...
page-drop-import-file = 拖放檔案以加入此收藏集
...
gallery-uncredited = 無建立者
gallery-uncredited-desc = 此部分中的條目沒有建立者。
...
gallery-group-auto-title = 自動分組
gallery-group-type = 類型
gallery-group-type-title = 按條目類型分組
gallery-group-creator = 建立者
gallery-group-creator-title = 按建立者分組
...
gallery-type-small-title = 較小的雜誌文字
gallery-type-large = 大
gallery-type-large-title = 較大的雜誌文字
...
schedule-apply-to-pinned = 套用至 Pinned
...
schedule-of-collection = 於 { $name }
schedule-of-collection-in-library = 於 { $collection }（{ $library }）
...
progress-print-preparing = 正在準備教學大綱…
progress-print-failed = 無法儲存教學大綱
...
file-filter-pdf = PDF
dialog-save-word = 將教學大綱另存為 Word
file-filter-word = Word
dialog-save-markdown = 將教學大綱另存為 Markdown
file-filter-markdown = Markdown
dialog-save-html = 將教學大綱另存為 HTML
...
explorer-menu-add-to-home = 新增至首頁
explorer-menu-remove-from-home = 從首頁移除
...
my-annotations-empty-color-filter = 沒有符合所選顏色的註解
...
annotations-quote-order-menu = 排序註解
annotations-quote-order-location = 位置
annotations-quote-order-location-title = 依文件中的位置排序引文
annotations-quote-order-date-added = 新增時間
annotations-quote-order-date-added-title = 依新增時間排序引文（最早在前）
...
my-annotations-menu-color = 依顏色篩選
my-annotations-menu-color-clear = 清除顏色篩選
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = 黃色
my-annotations-color-light-yellow = 淺黃
my-annotations-color-red = 紅色
my-annotations-color-green = 綠色
my-annotations-color-blue = 藍色
my-annotations-color-purple = 紫色
my-annotations-color-magenta = 洋紅
my-annotations-color-orange = 橙色
my-annotations-color-gray = 灰色
