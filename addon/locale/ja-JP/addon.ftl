...
my-annotations-empty-color-filter = 選択した色の注釈はありません
...
annotations-quote-order-menu = 注釈を並べ替え
...
my-annotations-menu-color = 色で絞り込む
my-annotations-menu-color-clear = 色フィルターを解除
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = 黄
my-annotations-color-light-yellow = 薄い黄
my-annotations-color-red = 赤
my-annotations-color-green = 緑
my-annotations-color-blue = 青
my-annotations-color-purple = 紫
my-annotations-color-magenta = マゼンタ
my-annotations-color-orange = オレンジ
my-annotations-color-gray = グレー
