...
page-drop-import-file = 拖放文件以添加到此文献集
...
class-insert-here = 在此添加{ $nomenclature }
...
gallery-uncredited = 无创建者
gallery-uncredited-desc = 此部分中的条目没有创建者。
...
gallery-group-auto = 自动
gallery-group-auto-title = 自动分组
gallery-group-type = 类型
gallery-group-type-title = 按条目类型分组
gallery-group-creator = 创建者
gallery-group-creator-title = 按创建者分组
...
progress-print-preparing = 正在准备教学大纲…
progress-print-failed = 无法保存教学大纲
...
file-filter-pdf = PDF
dialog-save-word = 将教学大纲另存为 Word
file-filter-word = Word
dialog-save-markdown = 将教学大纲另存为 Markdown
file-filter-markdown = Markdown
dialog-save-html = 将教学大纲另存为 HTML
...
explorer-menu-add-to-home = 添加到主页
explorer-menu-remove-from-home = 从主页移除
...
explorer-go-to-my-annotations = 前往批注动态
...
my-annotations-empty-color-filter = 没有与所选颜色匹配的批注
...
annotations-quote-order-menu = 排序批注
...
my-annotations-menu-color = 按颜色筛选
my-annotations-menu-color-clear = 清除颜色筛选
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = 黄色
my-annotations-color-light-yellow = 浅黄
my-annotations-color-red = 红色
my-annotations-color-green = 绿色
my-annotations-color-blue = 蓝色
my-annotations-color-purple = 紫色
my-annotations-color-magenta = 品红
...
my-annotations-layout-grid-title = 全宽封面与摘录墙
explorer-empty = 暂无内容
