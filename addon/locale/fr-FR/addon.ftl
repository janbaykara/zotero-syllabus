...
userGuide-exit = Quitter le tour
...
page-density-cycle = Passer à { $next }
...
settings-priorities-desc = Personnalisez les noms, couleurs et l’ordre des priorités de ce syllabus.
settings-priorities-global-title = Priorités par défaut globales
settings-priorities-global-desc = Les nouveaux syllabus copient ces priorités. Les existants gardent leurs propres listes.
settings-priorities-global-link = Modifier les valeurs globales…
settings-priorities-global-done = Terminé
settings-priorities-global-reset = Réinitialiser aux valeurs intégrées
settings-priorities-set-global = Utiliser comme valeurs globales
settings-priorities-set-global-confirm-title = Utiliser comme valeurs globales ?
settings-priorities-set-global-confirm-message =
    Cela remplacera vos priorités par défaut globales par celles de ce syllabus. Les nouveaux syllabus copieront ces noms, couleurs et ordre. Les syllabus existants ne changent pas.
settings-priorities-set-global-done = Enregistré comme valeurs globales pour les nouveaux syllabus
settings-priorities-reset-global = Réinitialiser aux valeurs globales
settings-priorities-reset-global-confirm-title = Réinitialiser aux valeurs globales ?
settings-priorities-reset-global-confirm-message =
    Cela remplacera les priorités de ce syllabus par vos valeurs globales. Les lectures utilisant des priorités absentes de la liste globale devront être déplacées ou effacées.
settings-priorities-reset-global-done = Priorités réinitialisées aux valeurs globales
...
settings-priority-delete-title = Supprimer la priorité ?
settings-priority-delete-message =
    { $count ->
        [one] { $count } lecture utilise « { $name } ». Choisissez quoi en faire avant de supprimer cette priorité.
       *[other] { $count } lectures utilisent « { $name } ». Choisissez quoi en faire avant de supprimer cette priorité.
    }
settings-priority-delete-migrate-label = Déplacer les lectures vers
settings-priority-delete-migrate = Déplacer et supprimer
settings-priority-delete-clear = Effacer la priorité
settings-priority-delete-cancel = Annuler
...
gallery-menu-packing = Disposition
gallery-packing-vertical = Vertical
gallery-packing-vertical-title = Couvertures avec résumés en pile de lecture
gallery-packing-grid = Grille
gallery-packing-grid-title = Tuiles magazine de taille égale
gallery-packing-packed = Compact
...
magazine-blurb-open = Ouvrir cet extrait dans le lecteur
...
progress-print-preparing = Préparation du syllabus…
progress-print-failed = Impossible d’enregistrer le syllabus
...
file-filter-pdf = PDF
dialog-save-word = Enregistrer le syllabus en Word
file-filter-word = Word
dialog-save-markdown = Enregistrer le syllabus en Markdown
file-filter-markdown = Markdown
dialog-save-html = Enregistrer le syllabus en HTML
...
explorer-menu-add-to-home = Ajouter à l’accueil
explorer-menu-remove-from-home = Retirer de l’accueil
...
explorer-go-to-my-annotations = Aller à Annotation Feed
...
my-annotations-empty-color-filter = Aucune annotation ne correspond aux couleurs sélectionnées
...
annotations-quote-order-menu = Trier les annotations
annotations-quote-order-location = Emplacement
annotations-quote-order-location-title = Ordonner les citations par position dans le document
annotations-quote-order-date-added = Ajout
annotations-quote-order-date-added-title = Ordonner les citations par date d’ajout (plus anciennes d’abord)
annotations-activity-gap-later =
    { $unit ->
        [day] { $count ->
            [one] un jour plus tard
           *[other] { $count } jours plus tard
        }
        [week] { $count ->
            [one] une semaine plus tard
           *[other] { $count } semaines plus tard
        }
        [month] { $count ->
            [one] un mois plus tard
...
annotations-activity-gap-earlier =
    { $unit ->
        [day] { $count ->
            [one] un jour plus tôt
           *[other] { $count } jours plus tôt
        }
        [week] { $count ->
            [one] une semaine plus tôt
           *[other] { $count } semaines plus tôt
        }
        [month] { $count ->
            [one] un mois plus tôt
...
my-annotations-menu-color = Filtrer par couleur
my-annotations-menu-color-clear = Effacer le filtre de couleur
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Jaune
my-annotations-color-light-yellow = Jaune clair
my-annotations-color-red = Rouge
my-annotations-color-green = Vert
my-annotations-color-blue = Bleu
my-annotations-color-purple = Violet
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Orange
...
my-annotations-layout-grid-title = Mur pleine largeur de couvertures et citations
