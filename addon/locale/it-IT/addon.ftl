...
page-density-cycle = Passa a { $next }
page-density-row = Riga
page-density-standard = Standard
page-density-expanded = Espanso
page-reader-enable = Attiva le caselle di controllo
page-reader-disable = Disattiva le caselle di controllo
...
progress-print-preparing = Preparazione del programma…
progress-print-failed = Impossibile salvare il programma
...
file-filter-pdf = PDF
dialog-save-word = Salva programma come Word
file-filter-word = Word
dialog-save-markdown = Salva programma come Markdown
file-filter-markdown = Markdown
dialog-save-html = Salva programma come HTML
...
my-annotations-empty-color-filter = Nessuna annotazione corrisponde ai colori selezionati
...
annotations-quote-order-menu = Ordina annotazioni
annotations-quote-order-location = Posizione
annotations-quote-order-location-title = Ordina le citazioni per posizione nel documento
annotations-quote-order-date-added = Aggiunto
annotations-quote-order-date-added-title = Ordina le citazioni per data di aggiunta (più vecchie prima)
annotations-activity-gap-later =
    { $unit ->
        ...
        [week] { $count ->
            [one] una settimana dopo
           *[other] { $count } settimane dopo
        }
        [month] { $count ->
            [one] un mese dopo
...
annotations-activity-gap-earlier =
    { $unit ->
        ...
        [week] { $count ->
            [one] una settimana prima
           *[other] { $count } settimane prima
        }
        [month] { $count ->
            [one] un mese prima
           *[other] { $count } mesi prima
        }
        [year] { $count ->
            [one] un anno prima
           *[other] { $count } anni prima
        }
       *[other] prima
    }
...
my-annotations-menu-color = Filtra per colore
my-annotations-menu-color-clear = Cancella il filtro colore
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Giallo
my-annotations-color-light-yellow = Giallo chiaro
my-annotations-color-red = Rosso
my-annotations-color-green = Verde
my-annotations-color-blue = Blu
my-annotations-color-purple = Viola
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Arancione
my-annotations-color-gray = Grigio
