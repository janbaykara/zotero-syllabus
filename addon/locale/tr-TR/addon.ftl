...
page-print = İzlence görünümündeki listeyi PDF olarak yazdır
...
progress-print-preparing = İzlence yazdırmaya hazırlanıyor…
progress-print-failed = İzlence PDF’si kaydedilemedi
