...
magazine-blurb-open = افتح هذا المقتطف في القارئ
...
my-annotations-empty-color-filter = لا توجد تعليقات بالألوان المحددة
...
annotations-quote-order-menu = ترتيب التعليقات
annotations-quote-order-location = الموقع
...
my-annotations-menu-color = التصفية حسب اللون
my-annotations-menu-color-clear = مسح تصفية اللون
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = أصفر
my-annotations-color-light-yellow = أصفر فاتح
my-annotations-color-red = أحمر
my-annotations-color-green = أخضر
my-annotations-color-blue = أزرق
my-annotations-color-purple = بنفسجي
my-annotations-color-magenta = أرجواني
my-annotations-color-orange = برتقالي
my-annotations-color-gray = رمادي
