...
enable-subcollections-message =
    ...
    • يُنشأ مجلد لكل محاضرة أو يُعتمد مجلد قائم، ويُعاد تسميته ليطابق المنهاج (على سبيل المثال «محاضرة 1: العنوان»).
    ...
    • إذا حذفت مجلد محاضرة، تعيد الإضافة إنشاءه.
...
page-print = طباعة القائمة في عرض المنهاج بصيغة PDF
...
page-drop-import-file = أفلت ملف .syllabus للاستيراد
...
settings-subcollections-desc = معطّل افتراضيًا. عند التمكين، تحصل كل محاضرة على مجلد ضمن هذه المجموعة. تُنشأ المجلدات ويُعاد تسميتها وتُحذف لتطابق المنهاج — بما في ذلك المجموعات الفرعية القائمة التي قد تُحذف. إلغاء التفعيل يترك المجلدات في مكانها.
...
progress-print-preparing = جارٍ تجهيز المنهاج للطباعة…
progress-print-failed = تعذّر حفظ ملف PDF للمنهاج
