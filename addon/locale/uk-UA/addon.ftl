...
enable-subcollections-message =
    ...
    • Для кожного заняття створюється або переймається одна тека, яку перейменовують відповідно до силабуса (наприклад, «Заняття 1: Назва»).
    ...
    • Якщо ви вилучите теку заняття, додаток створить її знову.
...
page-compact-enable = Увімкнути компактний режим
page-compact-disable = Вимкнути компактний режим
...
page-print = Друкувати список у вигляді силабуса як PDF
...
page-drop-import-file = Перетягніть файл .syllabus для імпорту
...
settings-subcollections-desc = Типово вимкнено. Якщо увімкнено, кожне заняття отримує теку в цій колекції. Теки створюються, перейменовуються й вилучаються відповідно до силабуса — зокрема наявні дочірні колекції, які можуть бути вилучені. Вимкнення залишає теки на місці.
...
settings-priorities-desc = Налаштуйте назви пріоритетів, кольори та порядок сортування.
...
progress-print-preparing = Підготовка силабуса до друку…
progress-print-failed = Не вдалося зберегти PDF силабуса
