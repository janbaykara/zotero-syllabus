...
magazine-blurb-open = Відкрити цей уривок у читачі
...
my-annotations-empty-color-filter = Немає анотацій вибраних кольорів
...
annotations-quote-order-menu = Сортувати анотації
...
annotations-activity-gap-later =
    { $unit ->
        [day] { $count ->
            [one] день потому
            [few] { $count } дні потому
           *[many] { $count } днів потому
        }
        [week] { $count ->
            [one] тиждень потому
            [few] { $count } тижні потому
           *[many] { $count } тижнів потому
        }
        [month] { $count ->
            [one] місяць потому
            [few] { $count } місяці потому
           *[many] { $count } місяців потому
        }
        [year] { $count ->
            [one] рік потому
            [few] { $count } роки потому
           *[many] { $count } років потому
        }
       *[other] потому
    }
annotations-activity-gap-earlier =
    { $unit ->
        ...
        [week] { $count ->
            [one] тижнем раніше
            [few] { $count } тижні раніше
           *[many] { $count } тижнів раніше
        }
        [month] { $count ->
            [one] місяцем раніше
            [few] { $count } місяці раніше
           *[many] { $count } місяців раніше
        }
        [year] { $count ->
            [one] роком раніше
            [few] { $count } роки раніше
           *[many] { $count } років раніше
        }
       *[other] раніше
    }
...
my-annotations-menu-color = Фільтр за кольором
my-annotations-menu-color-clear = Скинути фільтр за кольором
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Жовтий
my-annotations-color-light-yellow = Світло-жовтий
my-annotations-color-red = Червоний
my-annotations-color-green = Зелений
my-annotations-color-blue = Синій
my-annotations-color-purple = Фіолетовий
my-annotations-color-magenta = Пурпуровий
my-annotations-color-orange = Помаранчевий
my-annotations-color-gray = Сірий
