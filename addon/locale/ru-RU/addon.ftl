...
magazine-blurb-open = Открыть этот отрывок в читалке
...
my-annotations-empty-color-filter = Нет аннотаций выбранных цветов
...
annotations-quote-order-menu = Сортировать аннотации
...
my-annotations-menu-color = Фильтр по цвету
my-annotations-menu-color-clear = Сбросить фильтр по цвету
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Жёлтый
my-annotations-color-light-yellow = Светло-жёлтый
my-annotations-color-red = Красный
my-annotations-color-green = Зелёный
my-annotations-color-blue = Синий
my-annotations-color-purple = Фиолетовый
my-annotations-color-magenta = Пурпурный
my-annotations-color-orange = Оранжевый
my-annotations-color-gray = Серый
