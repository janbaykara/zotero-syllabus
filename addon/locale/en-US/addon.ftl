...
page-reader-enable = Enable checkboxes
page-reader-disable = Disable checkboxes
...
page-drop-import-file = Drop files to add them to this collection
...
class-insert-here = Add { $nomenclature } here
...
gallery-uncredited = No creator
gallery-uncredited-desc = Items in this section have no creator.
...
gallery-group-auto = Automatic
gallery-group-auto-title = Automatic grouping
gallery-group-type = Type
gallery-group-type-title = Group by item type
gallery-group-creator = Creator
gallery-group-creator-title = Group by creator
...
progress-print-preparing = Preparing syllabus…
progress-print-failed = Could not save the syllabus
...
dialog-save-word = Save Syllabus Word Document
file-filter-word = Word
dialog-save-markdown = Save Syllabus Markdown
file-filter-markdown = Markdown
dialog-save-html = Save Syllabus HTML
...
my-annotations-empty-color-filter = No annotations match the selected colours
...
annotations-quote-order-menu = Sort annotations
...
annotations-activity-gap-earlier =
    { $unit ->
        ...
        [week] { $count ->
            [one] a week earlier
           *[other] { $count } weeks earlier
        }
        [month] { $count ->
            [one] a month earlier
           *[other] { $count } months earlier
        }
        [year] { $count ->
            [one] a year earlier
           *[other] { $count } years earlier
        }
       *[other] earlier
    }
...
my-annotations-menu-color = Filter by colour
my-annotations-menu-color-clear = Clear colour filter
my-annotations-color-swatch = { $color }
my-annotations-color-yellow = Yellow
my-annotations-color-light-yellow = Light yellow
my-annotations-color-red = Red
my-annotations-color-green = Green
my-annotations-color-blue = Blue
my-annotations-color-purple = Purple
my-annotations-color-magenta = Magenta
my-annotations-color-orange = Orange
my-annotations-color-gray = Gray
